...
@Stateless
@Path("cst8218.turn0245.entity.sprite")
public class SpriteFacadeREST extends cst8218.turn0245.entity.AbstractFacade<Sprite> {
    @PersistenceContext(unitName = "SpriteMichael-ejbPU")
